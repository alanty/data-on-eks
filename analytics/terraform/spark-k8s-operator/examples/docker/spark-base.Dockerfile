...
#   e.g., aws ecr-public create-repository --repository-name spark3.5.1-hadoop3.2-aws-java-sdk-bundle-1.12.647 --region us-east-1
#---
# Step2: Docker Login:
...
#   docker buildx build --platform linux/amd64,linux/arm64 -t public.ecr.aws/<repoAlias>/spark3.5.1-hadoop3.2-aws-java-sdk-bundle-1.12.647:latest --push .
#--------------------------------------------------------------------------------------------
