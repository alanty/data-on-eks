...
ARG SPARK_BASE_IMAGE=111111111111.dkr.ecr.region.amazonaws.com/spark:3.4.0-hadoop3.4.0-aws-sdk1.12.739-20240611
...
FROM 111111111111.dkr.ecr.region.amazonaws.com/sbt-multiarch:1.6.2-openjdk11.0.13 as sbtenv
